/* ================================================================= *
 *  Global.cpp: Source file for global varibales                     *
 *                                                                   *
...
int query_flag=0;
int help_flag=0;
int index_read_flag=0;
int index_write_flag=0;

UINT_TYPE kmerSeedArray[13] = {
                            0xFFFFFFFFFF000000, //KMER_20
                            0xFFFFFFFFFC000000, //KMER_19
                            0xFFFFFFFFF0000000, //KMER_18
                            0xFFFFFFFFC0000000, //KMER_17
                            0xFFFFFFFF00000000, //KMER_16
                            0xFFFFFFFC00000000, //KMER_15
                            0xFFFFFFF000000000, //KMER_14
                            0xFFFFFFC000000000, //KMER_13
                            0xFFFFFF0000000000, //KMER_12
                            0xFFFFFC0000000000, //KMER_11
                            0xFFFFF00000000000, //KMER_10
                            0xFFFFC00000000000, //KMER_9
                            0xFFFF000000000000 //KMER_8
                        };
uint32_t kmerSizeArray[13] = {20, 19, 18, 17, 16, 15, 14, 13, 12, 11, 10, 9, 8};


uint16_t preComputedReverseComplement[65536] = {0};

/* Global mask for biti reverse manipulation */
uint16_t reverse_mask[8] = {
                                   0x00000003, /*  0-1 bits */
                                   0x0000000C, /*  2-3 bits */
                                   0x00000030, /*  4-5 bits */
                                   0x000000C0, /*  6-7 bits */
                                   0x00000300, /*  8-9 bits */
                                   0x00000C00, /*10-11 bits */
                                   0x00003000, /*12-13 bits */
                                   0x0000C000 /*14-15 bits */
                           };

UINT_TYPE global_mask_left[CHARACTERS_IN_UINT] = {
                                   0xC000000000000000, /*  2 bits */
...
UINT_TYPE global_mask_right[CHARACTERS_IN_UINT] = { 
