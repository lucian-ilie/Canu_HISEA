...
sub getAllowedResources ($$$$) {
    ...
    elsif ($alg eq "hisea")    {  $nam = "hisea (overlapper)"; }
...
sub configureAssembler () {
    ...
    ($err, $all) = getAllowedResources("cor", "hisea",    $err, $all);
    ($err, $all) = getAllowedResources("obt", "hisea",    $err, $all);
    ($err, $all) = getAllowedResources("utg", "hisea",    $err, $all);
