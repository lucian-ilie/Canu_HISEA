...
sub lookupStageLabel ($) {
    ...
    $ckp{'cor-hiseaConfigure'}               = $index++;
    $ckp{'cor-hiseaPrecomputeCheck'}         = $index++;  # + attempt
    $ckp{'cor-hiseaCheck'}                   = $index++;  # + attempt
    ...
    $ckp{'obt-hiseaConfigure'}               = $index++;
    $ckp{'obt-hiseaPrecomputeCheck'}         = $index++;  # + attempt
    ...
    $ckp{'utg-hiseaConfigure'}               = $index++;
    $ckp{'utg-hiseaPrecomputeCheck'}         = $index++;  # + attempt
